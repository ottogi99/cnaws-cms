<div>
    <x-loading-indicator />
    <h1 class="text-2xl font-semibold text-gray-900">농가 관리</h1>
                    ...
                    @forelse ($items as $item)
                        <x-table.row wire:loading.class.delay="opacity-50" wire:key="row-{{ $item->id }}">
                            ...
                            <x-table.cell>
                                <span href="#" class="inline-flex space-x-2 truncate text-sm leading-5">
                                    <x-icon.cash class="text-cool-gray-500" />
                                    <p class="text-cool-gray-500 truncate">{{ $item->farmhouse_name }}</p>
                                </span>
                            </x-table.cell>
                            ...
                            <x-table.cell>
                                <span href="#" class="inline-flex space-x-2 truncate text-sm leading-5">
                                    <x-icon.cash class="text-cool-gray-500" />
                                    <p class="text-cool-gray-500 truncate">{{ $item->farmhouse_address }}</p>
                                </span>
                            </x-table.cell>
                            ...
                            <x-table.cell>
                                <span href="#" class="inline-flex space-x-2 truncate text-sm leading-5">
                                    <x-icon.cash class="text-cool-gray-500" />
                                    <p class="text-cool-gray-500 truncate">{{ $item->farmhouse_contact }}</p>
                                </span>
                            </x-table.cell>
